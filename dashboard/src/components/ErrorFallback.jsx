  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-ax-bg">
      <div className="bg-ax-card border border-ax-border rounded-lg shadow-lg p-8 max-w-md w-full">
        <div className="mb-4">
          <div className="w-12 h-12 bg-ax-red/15 rounded-full flex items-center justify-center mx-auto">
            <svg className="w-6 h-6 text-ax-red" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        {error && (
          <div className="bg-ax-red/10 border border-ax-red/30 rounded p-3 mb-4">
            <p className="text-xs text-ax-red font-mono break-words">
        ...
        <div className="flex gap-2">
          <button
            onClick={onReset}
            className="flex-1 bg-ax-accent hover:bg-ax-accent2 text-ax-bg font-medium py-2 px-4 rounded transition"
          >
            Yeniden Dene
          </button>
          <button
